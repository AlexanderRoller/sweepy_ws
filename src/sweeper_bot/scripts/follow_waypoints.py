...
def main():
    ...
    # Inspection route (points that the robot will go through)
    inspection_route = [
        [1.966, 0.609, 0.034, 0.999],
        [2.454, 0.594, -0.032, 0.999],
        [2.943, 0.579, -0.052, 0.999],
    ]

    # Print waypoints to confirm they are correct
    print("Waypoints to be followed:")
    for pt in inspection_route:
        print(f"Position: ({pt[0]}, {pt[1]}), Orientation: (z: {pt[2]}, w: {pt[3]})")
    ...
    while rclpy.ok():
        ...
        while not navigator.isTaskComplete():
            ...
            if feedback and i % 5 == 0:
                ...
                print('Waypoints completed: ' + str(feedback.current_waypoint + 1))
                print('Waypoints remaining: ' + str(len(inspection_points) - feedback.current_waypoint - 1))
            
        result = navigator.getResult()
        if result == TaskResult.SUCCEEDED:
            print('Inspection shelves complete. Returning to start...')
